...
export function wasm_bindgen__convert__closures__invoke1_mut__h40eb5e311b5ad66b(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h8ff1eaae2b04e196(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h3ad1adf366122882(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h6d6ba48c13f15cfa(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hd7ef5cd54ab530d4(a: number, b: number): void;
